...
public class CustomInputLayoutPresenterImpl implements CustomInputLayoutContract.Presenter {

    private CustomInputLayoutContract.View mView;

    public CustomInputLayoutPresenterImpl(CustomInputLayoutContract.View view) {
        mView = view;
    }
