package com.manojbhadane.lib_formcontrol.adapter;
...
import com.manojbhadane.lib_formcontrol.R;
...
public class AutoCompleteAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            TextView lblName = (TextView) view.findViewById(R.id.txtAutocomplete);
            if (lblName != null)
